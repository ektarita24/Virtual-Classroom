...
public partial class Examination_MakeCQuestionPaper : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        string connString = ConfigurationManager.ConnectionStrings["VCDatabase"].ConnectionString;
        OleDbConnection connection = new OleDbConnection(connString);
        string countQuery = "Select * from CPaper";
        try
        {
            connection.Open();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        string connString = ConfigurationManager.ConnectionStrings["VCDatabase"].ConnectionString;
        OleDbConnection connection = new OleDbConnection(connString);
        string insertQuery = "INSERT INTO CPaper VALUES(@QN,@Question,@A,@B,@C,@D,@Correct)";
