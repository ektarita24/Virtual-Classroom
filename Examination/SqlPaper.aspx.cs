...
public partial class Examination_SqlPaper : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        string connString = ConfigurationManager.ConnectionStrings["VCDatabase"].ConnectionString;
        OleDbConnection connection = new OleDbConnection(connString);
        string selectQuery = "SELECT QuestionNo,Question,AnswerA,AnswerB,AnswerC,AnswerD FROM SqlPaper Order By QuestionNo";
    ...
    protected void btnSubmit_Click(object sender, System.EventArgs e)
    {
        ...
        string connString = ConfigurationManager.ConnectionStrings["VCDatabase"].ConnectionString;
        OleDbConnection connection = new OleDbConnection(connString);
        string selectQuery = "Select CorrectAnswer from SqlPaper where QuestionNo<=30 Order By QuestionNo";
