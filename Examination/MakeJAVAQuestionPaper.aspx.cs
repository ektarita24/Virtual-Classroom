...
public partial class Examination_MakeJAVAQuestionPaper : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        string connString = ConfigurationManager.ConnectionStrings["VCDatabase"].ConnectionString;
        OleDbConnection connection = new OleDbConnection(connString);
        string countQuery = "Select * from JavaPaper";
        try
        {
            connection.Open();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        string connString = ConfigurationManager.ConnectionStrings["VCDatabase"].ConnectionString;
        OleDbConnection connection = new OleDbConnection(connString);
        string insertQuery = "INSERT INTO JavaPaper VALUES(@QN,@Question,@A,@B,@C,@D,@Correct)";
